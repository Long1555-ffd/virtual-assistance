...
# Load Whisper Model
whisper_model = whisper.load_model("base", device=device1, download_root="./whisper")  # Use "large" for better accuracy
...
def generate_response(input_text, max_tokens=500):
...
if __name__ == "__main__":
    ...
    output_audio = "output.wav"  # Path to save output audio
