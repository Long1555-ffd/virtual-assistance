...
input_text = """Georgia’s relations with the EU have deteriorated sharply in recent months as Brussels has alleged that the government had resorted to authoritarian measures and adopted pro-Russian stances.

The ruling Georgian Dream party says it is not pro-Russian, and that it is committed to democracy and integration with the west.
"""
